...
test("packed artifact refuses missing notices and accidental private files", () => {
  const files = ["package.json", "README.md", "LICENSE", "NOTICE", "THIRD_PARTY_NOTICES.md",
    ...
    "patches/ink@6.2.0.patch", "patches/codex-0.152.1.patch", "patches/codex-0.153.0.patch", "patches/codex-0.153.4.patch", "patches/codex-0.154.0.patch", "patches/codex-0.155.0.patch", "patches/codex-0.155.1.patch", "patches/codex-0.156.1.patch", "patches/codex-0.157.0.patch"];
