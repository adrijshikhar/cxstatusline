...
## [0.4.0](https://github.com/adrijshikhar/cxstatusline/compare/v0.3.0...v0.4.0) (2026-09-13)
...
* **cli:** bring premium TUI look to install and doctor commands ([#7](https://github.com/adrijshikhar/cxstatusline/issues/7)) ([a9088ee](https://github.com/adrijshikhar/cxstatusline/commit/a9088ee4f9a95538c8a1af4771b8853ef34dbe66))
...
* support Codex 0.154.0 ([#6](https://github.com/adrijshikhar/cxstatusline/issues/6)) ([53d0b1b](https://github.com/adrijshikhar/cxstatusline/commit/53d0b1b5b48f33c9c37f5b18581fe0e052173d35))
* **ui:** add live progress bar for prebuilt downloads and compile stages ([e84a174](https://github.com/adrijshikhar/cxstatusline/commit/e84a1747ebeeeba9059f8989ff54c364252564b3))
* warn and stop before updating codex if prebuilt binaries are unavailable ([cc01e1b](https://github.com/adrijshikhar/cxstatusline/commit/cc01e1ba51779331a70a12140d99a81b249cdbf7))


### Bug Fixes

* **doctor:** clarify cx_version diagnostic label as cli vs generation ([#9](https://github.com/adrijshikhar/cxstatusline/issues/9)) ([0d4daa6](https://github.com/adrijshikhar/cxstatusline/commit/0d4daa680109c8bfb2bde6d8c6611feb87fe11f4))
* **doctor:** condense multiline compiler traces to single line summary ([#8](https://github.com/adrijshikhar/cxstatusline/issues/8)) ([685cdc8](https://github.com/adrijshikhar/cxstatusline/commit/685cdc8a60bce690d8127d14e796d0feeab0a2a5))
...
* **patch:** add recursion limit and local settings fix for codex 0.154.0 ([dc581db](https://github.com/adrijshikhar/cxstatusline/commit/dc581dbae8e098cbf4a029eebe33bad2715cfcac))
* **patch:** configure verified OpenAI Codex V8 dependencies before local cargo build ([d78b01b](https://github.com/adrijshikhar/cxstatusline/commit/d78b01bb64ae613813c710e9ca0f66ee4ab5cc29))
...
* **prebuilt:** allow appending missing assets to existing release ([5656b61](https://github.com/adrijshikhar/cxstatusline/commit/5656b61cca2dc6c21c4436aefe34eb9ea46f18c1))
...
* **version:** read version from package.json instead of hardcoded fallback ([e8835a0](https://github.com/adrijshikhar/cxstatusline/commit/e8835a078805ba6231f21a1a6235824691413e20))
