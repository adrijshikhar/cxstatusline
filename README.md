...
- **Update choices**: When the latest upstream release has no prebuilt, `cxstatusline update` uses the same keyboard controls to choose an available prebuilt, source build, stock update, or cancellation.
